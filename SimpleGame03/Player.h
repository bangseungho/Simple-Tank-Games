...
public:
	...
	//플레이어를 회전하는 함수이다. 
	void RotateYawBody(float angle);
	void RotatePitchBody(float angle);
...
{
public:
	CTigerPlayer(ComPtr<ID3D12Device> device, ComPtr<ID3D12GraphicsCommandList> cmdList, ComPtr<ID3D12RootSignature> rootSignature, void* pContext, int meshNum = 1);
