...
struct VS_INSTANCING_INPUT
{
    ...
    float timeAfterDeath : DEATHTIME;
};
...
VS_INSTANCING_OUTPUT VS_Instancing(VS_INSTANCING_INPUT input)
{
    ...
    output.normalW = mul(float4(input.normal, 0.0f), input.transform).xyz;
